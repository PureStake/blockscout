defmodule Explorer.EthRPC do
  ...
  @methods %{
    "eth_blockNumber" => @eth_block_number_action,
    "eth_getBalance" => @eth_get_balance_action,
    # "eth_getLogs" => @eth_get_logs_action
  }
